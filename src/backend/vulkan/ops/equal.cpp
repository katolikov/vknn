// Flat (row-major) Equal on the GPU: out = (a == b) ? 1 : 0, with N-D broadcasting at any rank.
...
// byte-matches shaders/equal.comp.
#include "flat_ops.h"
    ...
    namespace {
        ...
        struct EqualVk: VulkanOp {
            ...
            void prepare(const Node &node, VkOpEnv &env) override {
                ...
                pipe = env.pipeline(shader("equal", env.useFp16), 4, sizeof(PC), std::vector<uint32_t> {env.flatLocalSize});
            }
