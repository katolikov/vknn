# YoNoSplat encoder -> vxrt reproducers (2026-06-25)
...
if /tmp is cleared (the heavy artifacts live in /tmp, not git):
  ...
  # then: vx_convert onnx/yonosplat_encoder.onnx encoder_fp16.vxm --fp16
...
op_validate.py validates each new vxrt op (LayerNorm/MatMul/Softmax/Where/Einsum/...) vs onnxruntime.
