...
namespace vknn {
    ...
    enum class BinaryType : int32_t { kInvalid = -1, kMul = 0, kSub = 1, kDiv = 2, kMax = 3, kMin = 4, kPow = 5, kAdd = 6 };
    enum class ReduceType : int32_t { kInvalid = -1, kMean = 0, kSum = 1, kMax = 2, kMin = 3, kProd = 4, kL2 = 5 };
