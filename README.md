...
fp16 weights); `vknn_run_io` runs any multi-input/multi-output model. Full flow (compile, run, the C++
`vknn::Model` API, YoNoSplat): [skills/compile-and-run-a-model.md](skills/compile-and-run-a-model.md).
